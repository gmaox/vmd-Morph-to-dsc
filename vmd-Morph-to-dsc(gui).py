        ...
        for i in range(vmd.morph_keyframe_number):
            ...
            for s,sb in enumerate(str_mouth):
                if vmd.morph_keyframe_record[i]['MorphName']==str_mouth[s]:
                    ...
                    text2 ='MOUTH_ANIM('+str(jue_se.get()-1)+', 0,' +str(s)+ ' , '+str(int(buzhenjianshu))+', '+str(int(vmd.morph_keyframe_record[i]['Weight'] * 1000))+');\n'
                    xa =0
                    break
            if xa == 1 :
                for s,sb in enumerate(str_expre):
                    if vmd.morph_keyframe_record[i]['MorphName']==str_expre[s]:
                        ...
                        if bianlianga.get()==1:
                            buzhenjianshu = (vmd.morph_keyframe_record[i]['FrameTime']-vmd.morph_keyframe_record[i-1]['FrameTime'])*33
                            if buzhenjianshu < 0 : buzhenjianshu = 0
                        text2 ='EXPRESSION('+str(jue_se.get()-1)+', ' +str(s)+ ', '+str(int(buzhenjianshu))+', '+str(int(vmd.morph_keyframe_record[i]['Weight'] * 1000))+');\n'
                        break
            # str_text[i] = text1 + '\n' + text2
...
str_array = ["ADMIRATION", "感嘆", "ADMIRATION_CL", "null", "ADMIRATION_OLD", "感嘆２", "ADMIRATION_OLD_CL", "null", "CLARIFYING", "真面目", "CLARIFYING_CL", "null", "CLARIFYING_OLD", "真面目２", "CLARIFYING_OLD_CL", "null", "CLOSE", "まばたき", "CLOSE_OLD", "まばたき", "COOL", "null", "COOL_CL", "null", "CRY", "null", "CRY_OLD", "null", "DAZZLING", "null", "DAZZLING_CL", "null", "DAZZLING_OLD", "null", "DAZZLING_OLD_CL", "null", "EYEBROW_UP_LEFT", "眉上", "EYEBROW_UP_LEFT_CL", "null", "EYEBROW_UP_RIGHT", "眉上右", "EYEBROW_UP_RIGHT_CL", "null", "GENKI", "元気", "GENKI_CL", "null", "GENKI_OLD", "元気２", "GENKI_OLD_CL", "null", "GENTLE", "優しい", "GENTLE_CL", "null", "GENTLE_OLD", "優しい２", "GENTLE_OLD_CL", "null", "KIRI", "きり", "KIRI_CL", "null", "KIRI_OLD", "きり２", "KIRI_OLD_CL", "null", "KOMARIEGAO", "困り顔", "KOMARIWARAI", "困る", "KOMARIWARAI_CL", "null", "KONWAKU", "困惑", "KONWAKU_CL", "null", "KUMON", "苦悶", "KUMON_CL", "null", "KUTSUU", "苦痛", "KUTSUU_CL", "null", "LASCIVIOUS", "ジト目", "LASCIVIOUS_CL", "null", "LASCIVIOUS_OLD", "ジト目", "LASCIVIOUS_OLD_CL", "null", "LAUGH", "笑い", "LAUGH_OLD", "笑い", "NAGASI", "眼角上", "NAGASI_CL", "null", "NAGASI_OLD", "眼角上２", "NAGASI_OLD_CL", "null", "NAKI", "泣き", "NAKI_CL", "泣き闭", "NAYAMI", "悩み", "NAYAMI_CL", "null", "NEW_IKARI", "怒り", "NEW_IKARI_CL", "null", "NEW_IKARI_OLD", "怒り", "NEW_IKARI_OLD_CL", "null", "NIRAMI_OLD", "睨み", "NIRAMI_OLD_CL", "null", "OMOU", "思う", "OMOU_CL", "null", "OMOU_OLD", "思う２", "OMOU_OLD_CL", "null", "RESET", "null", "RESET_OLD", "null", "SAD", "悲しい", "SAD_CL", "null", "SAD_OLD", "悲しい２", "SAD_OLD_CL", "null", "SETTLED", "平然に", "SETTLED_CL", "null", "SETTLED_OLD", "平然に２", "SETTLED_OLD_CL", "null", "SETUNA", "せつな", "SETUNA_CL", "null", "SETUNA_OLD", "じと目", "SETUNA_OLD_CL", "null", "SMILE", "にこり", "SMILE_CL", "null", "SMILE_OLD", "にこり", "SMILE_OLD_CL", "null", "STRONG", "STRONG", "STRONG_CL", "null", "STRONG_OLD", "STRONG_OLD", "STRONG_OLD_CL", "null", "SUPSERIOUS", "びっくり", "SUPSERIOUS_CL", "null", "SURPRISE", "びっくり", "SURPRISE_CL", "null", "SURPRISE_OLD", "びっくり", "SURPRISE_OLD_CL", "null", "TSUYOKIWARAI", "強気笑い", "TSUYOKIWARAI_CL", "null", "UTURO", "じと目", "UTURO_CL", "null", "UTURO_OLD", "きり", "UTURO_OLD_CL", "null", "WINK", "ウィンク", "WINKG_L", "ウィンク左", "WINKG_R", "ウィンク右", "WINK_FT_CL", "null", "WINK_FT_OLD_CL", "null", "WINK_L", "ウィンク左", "WINK_L_OLD", "ウィンク左", "WINK_OLD", "ウィンク", "WINK_R", "ウィンク右", "WINK_R_OLD", "ウィンク右", "YARU", "殺す", "YARU_CL", "null", "YARU_OLD", "殺す２", "YARU_OLD_CL", "null", "M_A", "あ", "M_A_OLD", "あ", "M_CHU", "ちゅ", "M_CHU_OLD", "う", "M_E", "え", "M_E_OLD", "え", "M_E_DOWN", "null", "M_HAMISE", "い２", "M_HAMISE_DOWN", "はみせ", "M_HAMISE_E", "はみせ２", "M_HE", "ん", "M_HE_OLD", "口横狭め", "M_HE_S", "ん", "M_HERAHERA", "へらへ ら", "M_I", "い", "M_I_OLD", "い", "M_MOGUMOGU", "モグモグ", "M_NEKO", "ω", "M_NEUTRAL", "口角上げ", "M_NIYA", "にやにや", "M_NIYA_OLD", "にやにや", "M_O", "お", "M_O_OLD", "お", "M_PSP_A", "あ", "M_PSP_E", "え", "M_PSP_NIYA", "にや", "M_PSP_NIYARI", "にやり", "M_PSP_O", "お", "M_PSP_SURPRISE", "え２", "M_SAKEBI", "あ２", "M_SAKEBI_L", " あ", "M_SANKAKU", "▲", "M_SHIKAKU", "◆", "M_SMILE", "え", "M_SMILE_OLD", "え", "M_SMILE_L", "え", "M_SURPRISE", "え２", "M_SURPRISE_OLD", "え２", "M_U", "う", "M_U_OLD", "う"]
